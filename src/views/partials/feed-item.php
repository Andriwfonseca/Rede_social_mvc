<div class="box feed-item">
    <div class="box-body">
        ...
        <div class="feed-item-body mt-10 m-width-20">
            <!-- CONTEUDO POST -->
            <?=nl2br($data->body); ?><!-- nl2br(funcao que altera pulada de linha para <br>) -->
        </div>
        <div class="feed-item-buttons row mt-20 m-width-20">
            <!-- Curtida e comentarios -->
            <!-- $data->liked pra saber se ja curtiu o post, e likeCount a quantidade de likes -->
